...
import { Button, Card, CardBody, CardSubtitle, CardText, CardTitle, Badge} from 'reactstrap'
    ...
    return (
      <div>
        <Card style={{padding: "10px 5px"}} className="cart">
          <CardTitle style={{margin: 10 }}>You order:</CardTitle>
          <hr/>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <Button
                            style={{height: 25, padding: 0, width: 15, marginRight: 10}}
                            onClick={this.removeItem.bind(this, item)}
                            color="link"
                          >
                            -
                          </Button>
                          <span style={{marginLeft: 5}} id="item-quantity">{item.quantity}x</span>
                        </div>
                      </div>
                    )
                  }
